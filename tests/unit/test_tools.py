...
class TestTools(unittest.TestCase):
    ...
    def test_validate_and_sanitize_email_valid(self):
        ...
        self.assertEqual(validate_and_sanitize_email(" User.Name+tag@Example.COM "), "user.name+tag@example.com")
        self.assertEqual(validate_and_sanitize_email("alice@domain.co.uk"), "alice@domain.co.uk")
    ...
    def test_send_news_email_dry_run(self):
        ...
        with patch.dict(os.environ, {"DRY_RUN_MODE": "true", "SENDGRID_API_KEY": ""}):
    ...
    def test_send_news_email_missing_api_key_prod(self):
        ...
        with patch.dict(os.environ, {"DRY_RUN_MODE": "false", "SENDGRID_API_KEY": ""}):
    ...
    def test_send_news_email_auth_error_401(self):
        ...
        error_body = json.dumps({"errors": [{"message": "Invalid API key"}]}).encode("utf-8")
        ...
        with patch.dict(os.environ, {"DRY_RUN_MODE": "false", "SENDGRID_API_KEY": "SG.invalid_key"}), \
